...
# Add `~/bin` to the `$PATH`
export PATH="/usr/local/share/npm/bin:$HOME/bin:$PATH:${JAVA_HOME}/bin:~/adt-bundle-mac-x86_64-20130522/sdk/tools:~/adt-bundle-mac-x86_64-20130522/sdk/platform-tools:/usr/local/sbin"
